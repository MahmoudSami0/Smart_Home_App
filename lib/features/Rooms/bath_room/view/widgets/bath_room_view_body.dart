...
import 'bath_room_item_builder.dart';

class BathRoomViewBody extends StatelessWidget {
  const BathRoomViewBody({Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              BlocBuilder<BathRoomCubit,BathRoomState>(
                builder: (context, state) {
                  if(state is DataLoading){
                    return const Center(child: CircularProgressIndicator(),);
                  }else{
                    return BathRoomItemBuilder();
                  }
